from lora_ctp.ctp_node import LoRA_CTP_Node, Packet
from time import time, sleep, strftime

class LoRa_CTP_Receiver(LoRA_CTP_Node):

    def __init__(self, mesh_mode = False, debug_hops = False, adapter = None, 
                    NEXT_ACTION_TIME_SLEEP = 0.1):
        LoRA_CTP_Node.__init__(self, mesh_mode, debug_hops, adapter = adapter)
