...
class LoRa(object):
    ...
    backup_registers = []
    verbose = True
    dio0_mapping = None         # store the dio mapping here
    ...
    def _dio0(self, channel):
        ...
        self.backUpTimeOut = 0
        if self.dio0_mapping == 0:
            self.on_rx_done()
        elif self.dio0_mapping == 1:
            self.on_tx_done()
        elif self.dio0_mapping == 2:
            self.on_cad_done()
        else:
    ...
    def recv(self, size):
        ...
        """
        self.set_payload_length(size)
        self.set_mode(MODE.SLEEP)
        self.set_dio_mapping(0)
        self.reset_ptr_rx()
        self.set_mode(MODE.RXCONT)
        BOARD.add_event_dio0(self._dio0, self.backUpTimeOut, self.blocked)
    ...
    def get_dio_mapping_1(self, mapping):
        ...
        self.dio0_mapping = mapping >> 6 & 0x03
        return self.dio0_mapping
